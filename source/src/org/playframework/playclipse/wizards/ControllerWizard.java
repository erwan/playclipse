...
public class ControllerWizard extends Wizard implements INewWizard {
	private ControllerWizardPage page;
	...
	private void doFinish(
		...
		monitor.beginTask("Creating " + controllerName, 2);
		...
		final IFile file = container.getFile(new Path(controllerName + ".java"));
		try {
			InputStream stream = openContentStream(controllerName);
			if (file.exists()) {
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "org.playframework.playclipse", IStatus.OK, message, null);
